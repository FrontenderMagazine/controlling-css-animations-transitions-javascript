...
[Переходы][1] в CSS применяются к элементу, при этом изменение свойства должно происходить постепенно на протяжении определённого отрезка времени. С 
[анимациями][2] всё немного по-другому. Они дают более точный контроль над 
